namespace BayuOrtak.Core.Attributes.DataAnnotations
{
    ...
    /// <summary>
    /// Pozitif tam sayılar için bir aralık doğrulaması yapan <see cref="RangeAttribute"/> sınıfıdır. Bu sınıf, 1 ile <see cref="Int32.MaxValue"/> arasında bir değerin geçerli olduğunu doğrular.
    /// </summary>
